...
class Request:
    ...
    def validDate(self):   
        while True:
            try:
                self.requestdate = datetime.date(datetime.strptime(input("What date do you need help? (YYYY-MM-DD): ") ,'%Y-%m-%d'))
    ...
    def validTime(self):   
        while True: 
            try:
                self.requesttime = datetime.time(datetime.strptime(input("What time do you need help? (HH:MM): "), "%H:%M"))
            except ValueError:
