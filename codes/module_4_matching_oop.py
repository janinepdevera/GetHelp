...
def PrintMatch(mFinal):
    """
    Prints the details of the matched request/support
    ...
    Returns
    -------
    Details of the matched request/support
    username: str
        Matched user
    Cat: str
        Matched category
    Opt: str
        Matched option of the category
    Org: str
        Matched origin
    Dest: str
        Matched destination
    ...
    Time: time
        Matched time
    AddInfo: str
        Additional information for the request/support
...
class Matches:
    """
    A class to run the matching algorithm for requests and support
    
    Attributes
    ----------
    pairdb: dataframe
        A dataframe containing request and support details
    matches: dataframe
        A dataframe containing the details of the matched request/suppor    
    """
    ...
    def genpairdb(self):
        """
        A function that generates the matching parameters of the requests/support
    ...
    def getpairdb(self):
        """
        Get the dataframe of full join of requests and support dataframes
        generated by genpairdb function

        Returns
        -------
        pairdb: dataframe
            A full join of the request and support details,
            omitting rows matched to the User itself
        """
    ...
    def genMatchesdb(self):
        """
        A function that generates the matched pair per request/support
    ...
    def getMatchesdb(self):
        """
        Get the dataframe of the matched pair of request and support
        generated by genMatchesdb function

        Returns
        -------
        matches: dataframe
            A dataframe containing the details of the matched request/support
        """
    ...
    def genMatch(self):
        """
        A function that asks the User whether he has a pending Request/Support in GetHelp
        and returns the final match for the request/support

        Returns
        -------
        PrintMatch: function
            Returns the details of the matched request/support
    ...
    def runAll(self):
        """
        Runs all necessary functions for class Matches
